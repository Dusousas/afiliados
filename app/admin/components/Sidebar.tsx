...
const navItems: NavItem[] = [
  ...
  { label: "Gerenciar Cupom", id: "cupom", icon: FiTag },
  { label: "Gerenciar Indicações", id: "indicacoes", icon: FiUserPlus },
  { label: "GerenciarMateriais", id: "materiais", icon: FiBookOpen },
  { label: "Gerenciar Prêmios", id: "premios", icon: FiStar },
